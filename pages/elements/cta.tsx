            ...
            <div className="page-content">
                <div className="container">
                    <h2 className="title text-center mb-5">
                        Newsletter Banner{' '}
                        <span className="title-separator">/</span> With
                        Background
                    </h2>
                    ...
                    <h2 className="title text-center mb-5">
                        Newsletter Banner{' '}
                        <span className="title-separator">/</span> With Dark
                        Background
                    </h2>
                </div>
                ...
                <div className="container">
                    <h2 className="title text-center mb-5">
                        Newsletter Banner{' '}
                        <span className="title-separator">/</span> Without
                        Background
                    </h2>
                    ...
                    <h2 className="title text-center mb-5">
                        Call to Action{' '}
                        <span className="title-separator">/</span> Newsletter
                        Banner <span className="title-separator">/</span> With
                        Background
                    </h2>
                    <div
                    ...
                    <h2 className="title text-center mb-5">
                        Call to Action{' '}
                        <span className="title-separator">/</span> Newsletter
                        Banner <span className="title-separator">/</span> No
                        Background
                    </h2>
                ...
                <div className="container">
                    <h2 className="title text-center mb-5">
                        Sale Banner <span className="title-separator">/</span>{' '}
                        With Background
                    </h2>
