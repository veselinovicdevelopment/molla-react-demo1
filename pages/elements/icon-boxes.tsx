                        ...
                        <div className="col-lg-4 col-sm-6">
                            <div className="icon-box text-center">
                                ...
                                <div className="icon-box-content">
                                    ...
                                    <p>
                                        Pellentesque a diam sit amet mi
                                        ullamcorper vehicula. Nullam quis massa
                                        sit amet nibh viverra malesuada.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-4 col-sm-6">
                            <div className="icon-box icon-box-left">
                                ...
                                <div className="icon-box-content">
                                    ...
                                    <p>
                                        Pellentesque a diam sit amet vehicula.
                                        Nullam quis massa sit amet nibh viverra
                                        malesuada.
                                    </p>
                                </div>
                            </div>
