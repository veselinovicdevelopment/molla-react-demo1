...
interface BlogFullWidthProps {
    showVideo: () => void;
}

const BlogFullwidth = (props: BlogFullWidthProps) => {
    const slug = useRouter().query.slug;
    const { data, loading, error } = useQuery(GET_POST, {
        variables: { slug },
    });
    const post: Post = data && data.post.single;
    const related: Post[] = data && data.post.related;
    const prev: Post = data && data.post.prev;
    const next: Post = data && data.post.next;
                                        ...
                                        <div className="entry-body">
                                            ...
                                            <div className="entry-content editor-content">
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        Sed egestas, ante et
                                                        vulputate volutpat, eros
                                                        pede semper est, vitae
                                                        luctus metus libero eu
                                                        augue. Morbi purus
                                                        libero, faucibus
                                                        adipiscing, commodo
                                                        quis, gravida id, est.
                                                    ...
                                                    <li>
                                                        Sed lectus. Praesent
                                                        elementum hendrerit
                                                        tortor. Sed semper lorem
                                                        at felis. Vestibulum
                                                        volutpat, lacus a
                                                        ultrices sagittis, mi
                                                        neque euismod dui, eu
                                                        pulvinar nunc sapien
                                                        ornare nisl. Phasellus
                                                        pede arcu, dapibus eu,
                                                        fermentum et, dapibus
                                                        sed, urna.
                                                    </li>
                                                </ul>
                                                ...
                                                <p>
                                                    ...
                                                    egestas, ante et vulputate
                                                    volutpat, eros pede semper
                                                    est, vitae luctus metus
                                                ...
                                                <p>
                                                    ...
                                                    adipiscing, commodo quis,
                                                    gravida id, est. Sed lectus.
                                                    Praesent elementum hendrerit
                                                    tortor. Sed semper lorem at
                                                    felis. Vestibulum volutpat,
                                                    lacus a ultrices sagittis,
                                                    mi neque euismod dui, eu
                                                    pulvinar nunc sapien ornare
                                                    nisl. Phasellus pede arcu,
                                                    dapibus eu, fermentum et,
                                                    dapibus sed, urna. Morbi
                                                    interdum mollis sapien. Sed
                                                    ac risus. Phasellus lacinia,
                                                    magna a ullamcorper laoreet,
                                                    lectus arcu pulvinar risus,
                                                    vitae facilisis libero dolor
                                                    a purus.
                                                </p>
                                                ...
                                                <p>
                                                    ...
                                                    ullamcorper laoreet, lectus
                                                    arcu pulvinar risus, vitae
                                                    facilisis libero dolor a
                                                    purus. Sed vel lacus. Mauris
                                                    nibh felis, adipiscing
                                                    varius, adipiscing in,
                                                    lacinia vel, tellus.
                                                    Suspendisse ac urna. Etiam
                                                    pellentesque mauris ut
                                                    lectus. Nunc tellus ante,
                                                    mattis eget, gravida vitae,
                                                    ultricies ac, leo. Integer
                                                    leo pede, ornare a, lacinia
                                                    eu, vulputate vel, nisl.
                                                    Suspendisse mauris. Fusce
                                                    accumsan mollis eros.
                                                    Pellentesque a diam sit amet
                                                    mi ullamcorper vehicula.
                                                    Integer adipiscing risus a
                                                    sem. Nullam quis massa sit
                                                    amet nibh viverra malesuada.
                                                    Nunc sem lacus, accumsan
                                                    quis, faucibus non, congue
                                                    vel, arcu.
                                                </p>
                                            </div>
                                    ...
                                    <div className="author-body">
                                        ...
                                        <div className="author-content">
                                            <p>
                                                ...
                                                cursus faucibus, tortor neque
                                                egestas auguae, eu vulputate
...
export default connect(null, { ...demoAction })(BlogFullwidth);
