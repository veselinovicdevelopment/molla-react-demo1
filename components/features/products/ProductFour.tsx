...
interface ProductProps {
    ...
    showQuickView: (slug: string) => void;
}

const ProductFour = (props: ProductProps) => {
    ...
    const onWishlistClick = (e: MouseEvent<HTMLElement>) => {
        e.preventDefault();
    ...
    const onCompareClick = (e: MouseEvent<HTMLElement>) => {
        e.preventDefault();
    ...
    const onQuickView = (e: MouseEvent<HTMLElement>) => {
        e.preventDefault();
    ...
    const mouseOverHandler = () => {
        let animDiff =
            ...
            ((ref.current!.querySelector('.product-body') as HTMLElement)!
                .offsetHeight +
                (ref.current!.querySelector('.product-media') as HTMLElement)!
                    .offsetHeight);
        let animDistance =
            (ref.current!.querySelector('.product-footer') as HTMLElement)!
                .offsetHeight - animDiff;
        ref.current!.querySelector('.product-footer')!.setAttribute(
            'style',
            'visibility: visible; transform: translateY(0);'
        );
        ref.current!.querySelector('.product-body')!.setAttribute(
            'style',
