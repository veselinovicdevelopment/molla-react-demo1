                                    ...
                                    <div className="row">
                                        <div className="col-md-6 mb-2 mb-md-0">
                                            ...
                                            <p>
                                                ...
                                                summer months. These wedges are
                                                perfect for holidays and home,
                                                with the thick cross-over strap
                                                design and heel strap with an
                                                adjustable buckle fastening.
                                                Featuring chunky soles with an
                                                espadrille and cork-style wedge.{' '}
                                            </p>
                                        </div>
                                        ...
                                        <div className="col-md-6">
                                            <h2>Fabric & care</h2>
                                            <p>
                                                As part of our Forever Comfort
                                                collection, these wedges have
                                                ultimate cushioning with soft
                                                padding and flexi soles. Perfect
                                                for strolls into the old town on
                                                holiday or a casual wander into
                                                the village.
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <div className="product-desc-content pt-2">
                            <div className="container">
                                ...
                                <p>
                                    ...
                                    ut turpis. Suspendisse urna viverra non,
                                    semper suscipit, posuere a, pede. Donec nec
                                ...
                                <ul>
                                    ...
                                    <li>
                                        {' '}
                                        Height: 31cm; Width: 32cm; Depth: 12cm;
                                        Handle Drop: 61cm
                                    </li>
                                </ul>
                                <h3>Size</h3>
                        ...
                        <div className="product-desc-content pt-2">
                            <div className="container">
                                ...
                                <p>
                                    ...
                                    <br />
                                    We hope you’ll love every purchase, but if
                                    you ever need to return an item you can do
                                    so within a month of receipt. For full
                                    details of how to make a return, please view
                                    our{' '}
                                        ...
                                        <div className="col">
                                            ...
                                            <div className="review-content">
                                                <p>
                                                    ...
                                                    elit. Ducimus cum dolores
                                                    assumenda asperiores facilis
                                                    porro reprehenderit animi
                                                    culpa atque blanditiis
                                                    commodi perspiciatis
                                                    doloremque, possimus,
                                                    explicabo, autem fugit
                                ...
                                <div className="review">
                                    <div className="row no-gutters">
                                        ...
                                        <div className="col">
                                            ...
                                            <div className="review-content">
                                                <p>
                                                    Sed, molestias, tempore? Ex
                                                    dolor esse iure hic veniam
                                                    laborum blanditiis
                                                    laudantium iste amet. Cum
                                                    non voluptate eos enim, ab
                                                    cumque nam, modi, quas iure
                                                    illum repellendus,
