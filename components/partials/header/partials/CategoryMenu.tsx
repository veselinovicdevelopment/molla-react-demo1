...
const CategoryMenu = () => {
    ...
    return (
        <div className="dropdown category-dropdown">
            <ALink href="/shop/sidebar/list" className="dropdown-toggle">
                Browse Categories
            </ALink>
            ...
            <div className="dropdown-menu">
                <nav className="side-nav">
                    <ul className="menu-vertical sf-arrows">
                        <li
                            className={
                                query.category == 'electronics' ? 'active' : ''
                            }
                        >
                            <ALink
                        ...
                        <li
                            className={
                                query.category == 'gift-idea' ? 'active' : ''
                            }
                        >
                            <ALink
                        ...
                        <li
                            className={
                                query.category == 'lighting' ? 'active' : ''
                            }
                        >
                            <ALink
                        ...
                        <li
                            className={
                                query.category == 'sofas-and-sleeper-sofas'
                                    ? 'active'
                                    : ''
                            }
                        >
                        ...
                        <li
                            className={
                                query.category == 'armchairs-and-chaises'
                                    ? 'active'
                                    : ''
                            }
                        >
                        ...
                        <li
                            className={
                                query.category == 'decoration' ? 'active' : ''
                            }
                        >
                            <ALink
                        ...
                        <li
                            className={
                                query.category == 'kitchen-cabinets'
                                    ? 'active'
                                    : ''
                            }
                        >
                        ...
                        <li
                            className={
                                query.category == 'coffee-and-tables'
                                    ? 'active'
                                    : ''
                            }
                        >
                        ...
                        <li
                            className={
                                query.category == 'furniture' ? 'active' : ''
                            }
                        >
                            <ALink
